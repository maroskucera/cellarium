...
VALUES (@title, @description, @quest_type, @quest_date, @quest_line_id, @quest_giver, @reminder_time, @sort_order, @recurrence_type, @recurrence_n, @recurrence_unit, @recurrence_end_date, @recurrence_instance, @recurrence_max_instances)
RETURNING id;
